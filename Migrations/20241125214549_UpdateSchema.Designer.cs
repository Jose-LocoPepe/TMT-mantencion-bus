...
namespace TMTmantencion.Migrations
{
    ...
    [Migration("20241125214549_UpdateSchema")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TMT_mantencion.Models.Bus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TMT_mantencion.Models.Chofer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TMT_mantencion.Models.Tramo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TMT_mantencion.Models.Viaje", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TMT_mantencion.Models.Viaje", b =>
                {
                    b.HasOne("TMT_mantencion.Models.Bus", "IdBusNavigation")
                        .WithMany("Viajes")
                        .HasForeignKey("IdBus")
                        .IsRequired()
                        .HasConstraintName("viaje_ibfk_1");

                    b.HasOne("TMT_mantencion.Models.Chofer", "IdChoferNavigation")
                        .WithMany("Viajes")
                        .HasForeignKey("IdChofer")
                        .IsRequired()
                        .HasConstraintName("viaje_ibfk_2");

                    b.HasOne("TMT_mantencion.Models.Tramo", "IdTramoNavigation")
                        .WithMany("Viajes")
